...
>
  ...
  <option value="NEW">NEW</option>  {/* Assuming 'NEW' is based on product creation date */}
                ...
                <div className="py-8">
                <div className="flex justify-between items-center bg-[#8A0404] p-4 pl-16 pr-16">
  ...
  <div className="hidden md:flex space-x-4">
    ...
    >
      ...
      <option value="low-high">In Stock</option>
      <option value="high-low">Out of Stock</option>
    </select>
