...
>
    ...
    <div className="bg-cover bg-center h-auto p-10" style={{ backgroundImage: 'url("/../img/home/building.jpg")' }}>
      <div className="text-center mb-10">
        {/* <h1 className="text-white text-4xl font-bold">CONTACT US</h1> */}
        <p className="text-yellow-600">We are eagerly waiting to hear from you.</p>
      </div>
