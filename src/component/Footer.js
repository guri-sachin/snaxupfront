...
const Footer = () => {
  return (
    ...
    <div className="mt-8 flex justify-center space-x-4 text-3xl text-blue-500">
      <FaFacebook className="hover:text-yellow-600 cursor-pointer" />
      <FaInstagram className="hover:text-yellow-600 cursor-pointer text-[#E60023]" />
      <FaLinkedin className="hover:text-yellow-600 cursor-pointer" />
      <FaPinterest className="hover:text-yellow-600 cursor-pointer text-[#E60023]" />
    </div>
